...
public class DriverCompositeServiceApplication {
	...
	public Docket apiDocumentation() {
		...
		return new Docket(SWAGGER_2)
			.select()
			.apis(basePackage("com.uber.microservices.composite.driver"))
	...
	public static void main(String[] args) {
		SpringApplication.run(DriverCompositeServiceApplication.class, args);
	}
}
