...
public interface DriverVehicleHistoryService {
    ...
    DriverVehicleHistory createDriverVehicleHistory(@RequestBody DriverVehicleHistory body);
    ...
    @GetMapping(
            value    = "/driver-vehicle-history",
            produces = "application/json")
    List<DriverVehicleHistory> getDriversVehicleHistory(@RequestParam(value = "driverId", required = true) int driverId);
